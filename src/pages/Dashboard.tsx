...
const overviewCards = [
  { label: "Waste Scanned", value: "247", change: "+12%", icon: Recycle },
  { label: "Reports Filed", value: "18", change: "+3", icon: FileCheck },
  { label: "Legal Consults", value: "5", change: "+2", icon: Gavel },
  { label: "Impact Score", value: "92", change: "+8%", icon: TrendingUp },
];
...
const timeline = [
  { action: "Waste analysis completed", type: "scan", time: "2 hours ago" },
  { action: "Violation report ECO-A3F2 resolved", type: "resolved", time: "1 day ago" },
  { action: "Consultation booked with Dr. Sharma", type: "legal", time: "2 days ago" },
  { action: "New report filed: ECO-B7K9", type: "report", time: "4 days ago" },
];
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Track your environmental impact and activity.
            </p>
          </motion.div>
